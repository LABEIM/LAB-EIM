  ...
  singletons: {
    ...
    registration: singleton({
      ...
      schema: {
        ...
        openDate: fields.text({ label: 'Opening Date (ISO format: YYYY-MM-DDTHH:mm:ss)', defaultValue: '2026-07-01T00:00:00' }),
        deadline: fields.text({ label: 'Initial Deadline Date (ISO format)', defaultValue: '2026-07-25T23:59:59' }),
        extendedDeadline: fields.text({ label: 'Extended Deadline Date (Optional ISO format)', defaultValue: '2026-07-31T23:59:59' }),
        selectionEndDate: fields.text({ label: 'Document Screening End Date (ISO format)', defaultValue: '2026-08-05T23:59:59' }),
        selectionResultsDate: fields.text({ label: 'Screening Announcement Date (ISO format)', defaultValue: '2026-08-06T00:00:00' }),
        technicalTestEndDate: fields.text({ label: 'Technical Test End Date (ISO format)', defaultValue: '2026-08-10T23:59:59' }),
        technicalTestResultsDate: fields.text({ label: 'Technical Test Announcement Date (ISO format)', defaultValue: '2026-08-11T00:00:00' }),
        interviewEndDate: fields.text({ label: 'Interview End Date (ISO format)', defaultValue: '2026-08-15T23:59:59' }),
        announcementDate: fields.text({ label: 'Final Announcement Date (ISO format)', defaultValue: '2026-08-17T00:00:00' }),
